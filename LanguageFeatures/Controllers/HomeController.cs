...
namespace LanguageFeatures.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ViewResult CreateProduct()
        {
            ...
            //Using object initializer instead
            Product myProduct = new Product
            {
                ProductID = 100,
                Name = "Kayak",
        ...
        public ViewResult UseExtensionEnumerable()
        {
            IEnumerable<Product> products = new ShoppingCart
            {
                Products = new List<Product>
                {
                    ...
                    new Product {Name="Lifejacket",Price=48.95M},
                    new Product {Name="Soccer ball",Price=19.50M },
                    new Product {Name="Corner flag",Price=35.95M}
                }
            };
        ...
        public ViewResult UseFilterExtensionMethod()
        {
            ...
            //=> reads as "goes to"
            //bool will be true if the category of prod is equal to "Soccer"
            //Func<Product, bool> categoryFilter = prod => prod.Category == "Soccer";
            //removed Func and put in foreach
            decimal total = 0;
            //foreach (Product prod in products.FilterByCategory("Soccer"))
            //Use filtering extension method

            //foreach (Product prod in products.Filter(categoryFilter))
            //Move lambda function to foreach
            //Added another filter when price >20
        ...
        public ViewResult FindProducts()
        {
            ...
            //QUERYING WITHOUT LINQ
                ...
                // });
                ////get the first 3 itesms in the array as results
            ...
            //QUERYING WITH LINQ DOT NOTATION

            var foundProducts = products.OrderByDescending(e => e.Price)
                                        .Take(3)
                                        .Select(e => new { e.Name, e.Price});
            //Deferred LINQ extension method
